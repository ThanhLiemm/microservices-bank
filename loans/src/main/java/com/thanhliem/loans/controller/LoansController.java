...
@Tag(
        name = "CRUD REST APIs for Loans in TL_Bank",
        description = "CRUD REST APIs in TL_Bank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside TL_Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @GetMapping("/fetch")
    public ResponseEntity<LoansDto> fetchLoanDetails(@RequestHeader("tl_bank" +
            "-correlation-id")
