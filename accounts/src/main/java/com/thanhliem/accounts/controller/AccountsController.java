...
@Tag(
        name = "CRUD REST APIs for Accounts in TL_Bank",
        description = "CRUD REST APIs in TL_Bank to CREATE, UPDATE, FETCH AND DELETE account " +
                "details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer &  Account inside TL_Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
